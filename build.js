...
var options_htmle = {
	...
	platforms: ['win64','osx64','linux'],
    version: '0.26.6',
	files: ['./htmle_app/source/**/**'],
	buildDir: './htmle_app/dist/',
	credits: './htmle_app/source/index.html',
	macCredits: './htmle_app/source/index.html',
	macIcns: './htmle_app/source/src/icons/appIcon.hqx',
	winIco: './htmle_app/source/src/icons/appIcon.ico',
};
...
}else if(appPlatform == 'htmle'){
	build_version(nw_htmle);
}
